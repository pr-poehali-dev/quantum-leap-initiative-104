...
const faqs = [
  {
    ...
    answer:
      "Основная зона работы — Москва и Московская область. Также реализуем проекты в других регионах России при достаточном объёме работ. Выезд и оценка объекта — бесплатно.",
  },
  {
