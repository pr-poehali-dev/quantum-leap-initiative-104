const partners = [
  ...
  { id: 5, logo: "https://cdn.poehali.dev/projects/a5534061-e108-4a3e-a7e8-8dd4e55bb3fd/bucket/cc45ab98-3a8c-4278-a539-d6c8a57e97d7.png", name: "FOGEL", contain: true },
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {partners.map((partner) => (
            <div
              key={partner.id}
              className="aspect-[3/2] flex items-center justify-center overflow-hidden"
            >
              {partner.logo ? (
                <img src={partner.logo} alt={partner.name} className={`w-full h-full ${partner.contain ? "object-contain" : "object-cover"}`} />
              ) : (
